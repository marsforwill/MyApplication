...
1. **启动应用**
   - 应用应显示深紫色背景与“今日塔罗占卜”标题
   - 页面顶部提供问题输入框与牌阵选择卡片

2. **输入问题**
   - 点击“请输入你的问题”文本框
   - 输入你想询问的内容，例如：“我的事业发展会如何？”
   - 若未输入问题，右侧“开始占卜”按钮将保持半透明并禁用
...
4. **开始占卜**
   - 在已输入问题并选择牌阵后，点击“开始占卜”
   - 根据牌阵类型，应用会随机抽取对应数量的卡牌，并生成个性化解读
   - 抽取结果立即展示在首页：包括用户问题、抽到的牌以及简要说明

5. **查看详情**
   - 点击“查看详情”按钮
   - 应跳转到结果页，展示完整牌阵、各牌位含义以及详细解读文本
   - 如果是七张牌布阵，会按照“现状/挑战/过去/未来/目标/方法/结果”排列显示

6. **重新抽牌**
   - 在首页点击“重新占卜”按钮即可保留原问题与牌阵设置并重新抽牌
   - 如需修改问题或牌阵，可在首页直接调整后再次点击“开始占卜”
